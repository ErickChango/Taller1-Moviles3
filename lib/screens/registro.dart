...
class _RegisterScreenState extends State<RegisterScreen> {
  ...
  Future<void> _register() async {
    if (_nameCtrl.text.trim().isEmpty ||
      ...
      _showDialog('Campos incompletos', 'Por favor completa todos los campos.');
      return;
    }
    ...
    try {
      final AuthResponse res = await Supabase.instance.client.auth.signUp(
        ...
        onTimeout: () => throw Exception('Tiempo de espera agotado. Verifica tu conexion a internet.'),
      );
      ...
      if (res.session != null) {
        ...
        _showDialog(
          'Cuenta creada!',
          'Te enviamos un correo de confirmacion a ${_emailCtrl.text.trim()}. '
          'Confirma tu email y luego inicia sesion.',
        ...
        _showDialog('Error', 'No se pudo crear la cuenta. Intenta de nuevo.');
      }
